...
- **macOS (Apple Silicon):** [credit-card-manager-0.1.106-arm64.dmg](https://github.com/searchlightdev/credit-card-manager-releases/releases/download/v0.1.106/credit-card-manager-0.1.106-arm64.dmg)
- **Windows:** [credit-card-manager-0.1.106-x64.exe](https://github.com/searchlightdev/credit-card-manager-releases/releases/download/v0.1.106/credit-card-manager-0.1.106-x64.exe)
